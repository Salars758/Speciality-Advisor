...
class QuestionUpdate(BaseModel):
    question_text: Optional[str] = Field(None, max_length=255)
    question_number: Optional[int] = Field(None, max_length=255)
...
class AnswerOptionUpdate(AnswerOptionBase):
    question_id: Optional[int] = Field(None, max_length=255)
    answer_text: Optional[str] = Field(None, max_length=255)
    score: Optional[Decimal] = Field(ge=0, le=100)
...
class TestSessionUpdate(BaseModel):
    user_id: Optional[int] = Field(None, max_length=255)
    test_id: Optional[int] = Field(None, max_length=255)
    total_score: Optional[Decimal] = Field(ge=0, le=100)
